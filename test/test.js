    ...
    describe('DeviceInfo.win', () => {
        ...
        describe('#setWindowInnerDimension()', () => {
            ...
            it('should set content to "1024x768"', () => {
                ...
                const content = document.getElementById('window-inner-dimension').lastElementChild.innerHTML;
        ...
        describe('#setWindowOuterDimension()', () => {
            ...
            it('should set content to "1024x768"', () => {
                ...
                const content = document.getElementById('window-outer-dimension').lastElementChild.innerHTML;
                assert.ok(content === '1024x768');
            });
        });
        ...
        describe('#setWindowMaxDimension()', () => {
            ...
            it('should set content to "1024x768"', () => {
                if (window.screen.availWidth !== undefined && window.screen.availHeight !== undefined) {
                    ...
                    const content = document.getElementById('window-max-dimension').lastElementChild.innerHTML;
                    assert.ok(content === '1024x768');
                }
            });
        });
