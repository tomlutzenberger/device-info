 ...
 */
const DeviceInfo=()=>{const n={getWindowInnerWidth:()=>window.innerWidth||"undefined",getWindowInnerHeight:()=>window.innerHeight||"undefined",setWindowInnerDimension:()=>{const e=`${n.getWindowInnerWidth()}x${n.getWindowInnerHeight()}`;return i("window-inner-dimension",e)},getWindowOuterWidth:()=>window.outerWidth||"undefined",getWindowOuterHeight:()=>window.outerHeight||"undefined",setWindowOuterDimension:()=>{const e=`${n.getWindowOuterWidth()}x${n.getWindowOuterHeight()}`;return i("window-outer-dimension",e)},getWindowMaxWidth:()=>window.screen.availWidth||"undefined",getWindowMaxHeight:()=>window.screen.availHeight||"undefined",setWindowMaxDimension:()=>{const e=`${n.getWindowMaxWidth()}x${n.getWindowMaxHeight()}`;return i("window-max-dimension",e)},getWindowSize:()=>{let e="";e=window.fullScreen?"Fullscreen":n.getWindowOuterWidth()===window.screen.availWidth&&n.getWindowOuterHeight()===window.screen.availHeight?"Maximized":160===n.getWindowOuterWidth()&&28===n.getWindowOuterHeight()?"Minimized":"Restored";return e},setWindowSize:()=>{const e=`${n.getWindowSize()}`;return i("window-size",e)}};const e=(n,...e)=>{const i=window.console;let t=Object.keys(e).map(n=>e[n]);t.unshift("[DeviceInfo]");if(t.length>=2)return"function"==typeof i[n]?(i[n].apply(console,t),!0):(i.error("console."+n+" is not a valid logging function."),i.debug.apply(console,t),!1);return!1};const i=(n,i)=>{const t=document.getElementById(n);if(null!==t){const n="undefined"===i?"text-danger":"text-success";return t.lastElementChild.innerHTML=`<span class="${n}">${i}</span>`,!0}return e("error","#window-max-dimension is not a DOM element"),!1};const t=()=>{n.setWindowInnerDimension();n.setWindowOuterDimension();n.setWindowMaxDimension();n.setWindowSize()};return{execute:t,log:e,injectIntoDom:i,win:n}},di=DeviceInfo();di.execute();